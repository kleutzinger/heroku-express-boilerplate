...
function addDataToSets(sets) {
  sets = _.map(sets, (set) => {
    ...
    set.html0 = "<a href='#'>ay</a>";
    set.html1 = ``;
    set.html2 = "<a href='#'>ay</a>";
